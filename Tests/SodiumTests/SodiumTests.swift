...
class SodiumTests: XCTestCase {
    ...
    func testSHA256Hash() {
        let message = "My Test Message".bytes
        let h = sodium.utils.bin2hex(sodium.cryptoHash.sha256.hash(message: message)!)!
        ...
        let h2 = sodium.utils.bin2hex(sodium.cryptoHash.sha256.hash(message: message2)!)!
        XCTAssertEqual(h2, "12a61f4e173fb3a11c05d6471f74728f76231b4a5fcd9667cef3af87a3ae4dc2")
    }
    
    func testSHA512Hash() {
        let message = "My Test Message".bytes
        let h = sodium.utils.bin2hex(sodium.cryptoHash.sha512.hash(message: message)!)!
        ...
        // Same test as libsodium's
        let message2 = "testing\n".bytes
        let h2 = sodium.utils.bin2hex(sodium.cryptoHash.sha512.hash(message: message2)!)!
        XCTAssertEqual(h2, "24f950aac7b9ea9b3cb728228a0c82b67c39e96b4b344798870d5daee93e3ae5931baae8c7cacfea4b629452c38026a81d138bc7aad1af3ef7bfd5ec646d6c28")
    }
